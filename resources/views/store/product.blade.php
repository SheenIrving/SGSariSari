                ...
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="lg:pl-20">
                        ...
                        <div class="flex flex-wrap items-center ">
                            ...
                            <div class="mb-4 mr-4 lg:mb-0">
                                <button
                                    class="flex items-center justify-center w-full h-10 p-2 text-gray-700 border border-gray-300 lg:w-11 hover:text-gray-50 dark:text-gray-200 dark:border-blue-600 hover:bg-red-600 hover:border-red-600 dark:bg-blue-600 dark:hover:bg-blue-500 dark:hover:border-blue-500 dark:hover:text-gray-300">
